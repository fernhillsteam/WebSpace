...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['login'])) {
   $errors = $users->userLoginAuthotication($_POST);
}
			...
			<div class="row justify-content-center">
				<div class="col-md-12 col-lg-10">
					<div class="wrap d-md-flex">
			      	...
			      	<div class="d-flex">
			      		<div class="w-100">
			      			<h3 class="mb-4">Welcome To Member LogIn</h3>
			      		</div>
								<!-- <div class="w-100">
				    ...
				    <div class="row">
                          ...
                          <div class="col">
                               <p class="text-right">Log In as Admin!<a href="../adminpage/login.php">&nbsp;Login</a></p>
                           </div>
                     </div>
				   <div class="form-group d-md-flex">
		              ...
		              <a href="../../index.php" target="__blank">Go back to Home<i><img src="../assets/icons/home-link.png"></i></a>
		        </div>
		      </div>
				</div>
			</div>
