...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['update'])) {
  ...
  $updateGallery = $users->updateTitleAlbumByAdmin($_POST);
...
if (isset($_GET['remove'])) {
  ...
  $remove = $users->deleteAlbumImgByAdmin($remove);
}

if (isset($_GET['removetitle'])) {
	
  $remove = preg_replace('/[^a-zA-Z0-9-]/', '', (int)$_GET['removetitle']);
  
  $remove = $users->deleteTitleImgByAdmin($remove);
}
       ...
       <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;"><strong>Add Gallery</strong></a>
          </div>
		...
		<div class="row">
	      ...
	      <div class="form-row">
              <div class="form-group col-md-3">
                  <label>Title</label>
                  <input type="text" name="title" id="Big" value="" class="form-control">
              </div>
			  <div class="form-group col-md-3">
                  <label>Date</label>
                  <input type="text" name="date" id="Small" value="" class="form-control">
              </div>
			  <div class="form-group col-md-3">
                  <label>Venue</label>
                  <input type="text" name="venue" id="Small" value="" class="form-control">
              </div>
			  <div class="form-group col-md-3">
                  <label>Description</label>
                  <input type="text" name="desp" id="Small" value="" class="form-control">
              </div>
			   <button name="create" type="submit" class="btn btn-success" style="margin-top:24px;margin-left:20px">Add</button>
		 ...
		 <?php
				      ...
				      $allAlbum = $users->selectAllAlbum();
                          if ($allAlbum) {
                       
                        foreach ($allAlbum as  $value) {				
				?> 
		  <div class="col-md-12">
                  ...
                  <div class="col-7 col-md-12">
				       <div class="row text-center">
					      <div class="col-md-4 text-center">
				            <p class="card-category"><?php echo $value->title;?></p>
						  </div>
						  <div class="col-md-4 text-center">
				            <p class="card-category"><?php echo $value->venue;?></p>
						  </div>
						  <div class="col-md-4 text-center">
				            <p class="card-category"><?php echo $value->date;?></p>
						  </div>
					   </div>	
					  <div class="container">
    <div class="row">
				...
				<div class='col-md-3'>
				      <p class="text-center">Supported image Resolution 1250 x 853px<p/>
						<form action="" method="POST"  enctype="multipart/form-data" >
	                       <div class="form-row">
	
                              <label for="inputPassword4">Album</label>
							  <input type="hidden" name ="album_id" value="<?php echo $value->id; ?>">
	                          <input type="file" name="album[]" class="form-control"  multiple/>
                              <button name="album" type="submit" class="btn btn-success" style="margin-top:24px;margin-left:20px">Add</button>
						...
						<?php
				      $album_id = $value->id;
				      $allGallImg = $users->selectAllGalleryImg($album_id);
                          if ($allGallImg) {
                       
                        foreach ($allGallImg as  $value1) {				
				?>
				<div class='col-md-3'>
				        <div class="gallimg">
				             <a class="remove"  data-toggle="modal" data-target="#scrapModal"  data-href="<?php echo $value1->sl_no;?>"><i class="fa fa-window-close"></i></a>
				            <!--<a href="" class="remove"  data-href="?remove=<?php echo $value1->sl_no;?>" data-toggle="modal" data-target="#confirm-delete" ><i class="fa fa-window-close"></i></a>-->
                             <img class="img-responsive" alt="" src="../../assets/images/gallery/album_<?php echo $value1->album_id; ?>/<?php echo $value1->image; ?>" />
						</div>
                </div> <!-- col-6 / end -->
              ...
              <div class="card-footer ">
				...
				<a class="btn btn-success"  data-toggle="modal" data-target="#editModal<?php echo $value->id;?>"  data-href="<?php echo $value->id;?>">Edit</a>
				<a class="btn btn-danger"  data-toggle="modal" data-target="#eventModal"  data-href="<?php echo $value->id;?>">Delete</a>
				</div>
              </div>
			  <?php
			  include 'galleryevent.php';
			  ?>
            </div>
...
<div class="modal fade" id="eventModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel1">Confirm to Delete?</h5>
        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&#215;</span>
        </button>
      </div>
