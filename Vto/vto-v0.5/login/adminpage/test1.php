...
if (isset($username)) {
 ...
 ?></strong></span>
    ...
    <div class="row">
				...
				?>
				<div class='col-md-6'>
				             <a class="remove"  data-toggle="modal" data-target="#scrapModal"  data-href="/vto-v0.1/login/adminpage/slider.php?remove=<?php echo $value->sl_no;?>"><i class="fa fa-window-close"></i></a>
